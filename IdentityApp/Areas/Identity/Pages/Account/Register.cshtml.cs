...
namespace IdentityApp.Application.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private IUserEmailStore<IdentityUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("The default UI requires a IdentityUser store with email support.");
            }
